...
public enum Talent {
	...
	//Challenge T4
	CLOSE_THE_GAP(148, 4), INVIGORATING_VICTORY(149, 4), ELIMINATION_MATCH(150, 4),
	//Elemental Strike T4
	ELEMENTAL_REACH(151, 4), STRIKING_FORCE(152, 4), DIRECTED_POWER(153, 4),
	//Feint T4
	FEIGNED_RETREAT(154, 4), EXPOSE_WEAKNESS(155, 4), COUNTER_ABILITY(156, 4),
	...
	//Ascended Form T4
	DIVINE_INTERVENTION(180, 4), JUDGEMENT(181, 4), FLASH(182, 4),
	//Trinity T4
	...
	//Ratmogrify T4
	RATSISTANCE(320, 4), RATLOMACY(321, 4), RATFORCEMENTS(322, 4);
	...
	public static void onScrollUsed( Hero hero, int pos, float factor, Class<?extends Item> cls ){
		...
		if (hero.hasTalent(RECALL_INSCRIPTION) && Scroll.class.isAssignableFrom(cls) && cls != ScrollOfAbility.class){
			if (hero.heroClass == HeroClass.CLERIC){
