...
public class WarHammer extends MeleeWeapon {
	...
	protected void duelistAbility(Hero hero, Integer target) {
		...
		int dmgBoost = augment.damageFactor(damageBoost(6 + Math.round(1.5f*buffedLvl()+1.5f*hero.weaponMastery)));
	...
	public String abilityInfo() {
		...
		int dmgBoost = damageBoost(6 + Math.round(1.5f*buffedLvl()+1.5f*hero.weaponMastery));
		if (levelKnown){
