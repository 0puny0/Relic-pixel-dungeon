...
public class DM101Sprite extends MobSprite{
    public DM101Sprite() {
        super();
        ...
        idle.frames( frames, 0+16, 1+16 );

        run = new Animation( 12, true );
        run.frames( frames, 6+16, 7+16, 8+16, 9+16 );

        attack = new Animation( 12, false );
        attack.frames( frames, 2+16, 3+16, 4+16, 0+16 );

        zap = new Animation( 8, false );
        zap.frames( frames, 5+16, 5+16, 1+16 );

        die = new Animation( 12, false );
        die.frames( frames, 10+16, 11+16, 12+16, 13+16, 14+16, 15+16 );
